...
describe('ScoreManager', () => {
    ...
    describe('统计计算测试', () => {
        test('应该正确计算混合答题的统计信息', async () => {
            await scoreManager.recordAnswer(true);  // 正确 +10
            await scoreManager.recordAnswer(false); // 错误 -10
            await scoreManager.recordAnswer(true);  // 正确
